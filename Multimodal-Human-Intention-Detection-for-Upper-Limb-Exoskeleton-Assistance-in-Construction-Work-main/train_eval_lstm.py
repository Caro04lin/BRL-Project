...
def train_model(model, train_loader, valid_loader, test_loader, criterion, optimizer, device, num_epochs=3):
    ...
    torch.save(model.state_dict(), 'fusion_movinet_final.pt')
    print("fusion_movinet_final.pt saved")
...
if __name__ == '__main__':
    ...
    model = FusionModel(movinet_config, num_classes=10, lstm_input_size=27, lstm_hidden_size=512, lstm_num_layers=2)
